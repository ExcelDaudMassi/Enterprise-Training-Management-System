                            ...
                            <div class="overflow-x-auto flex-1 min-w-0 custom-scrollbar">
                                <div class="min-w-[1000px] flex flex-col h-full relative">
                                    ...
                                    <div class="flex border-b border-gray-150 bg-gray-50 select-none shrink-0 sticky top-0 z-30 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
                                        ...
                                        <div class="w-48 p-4 shrink-0 font-extrabold text-[11px] text-gray-500 uppercase tracking-wider border-r border-gray-150 flex items-center bg-gray-50 sticky left-0 z-40 shadow-[2px_0_5px_rgba(0,0,0,0.015)]">
                                            Nama Ruangan
                                        </div>
                                        <!-- Days Column Headers -->
