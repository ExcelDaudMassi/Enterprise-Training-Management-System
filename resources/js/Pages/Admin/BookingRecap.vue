...
<template>
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-black bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent">Booking Recap</h1>
                <p class="text-sm text-slate-500 mt-1 font-medium">View history and recap of all facility booking requests</p>
            </div>
            <!-- Export Button -->
            <button
                @click="exportExcel"
                ...
                title="Download all recap as an Excel file"
            >
                        ...
                        <tr v-if="filteredBookings.length === 0">
                            <td colspan="6" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center gap-3">
                                    ...
                                    <span class="text-sm font-semibold text-slate-500">No booking data for this tab.</span>
                                </div>
                            </td>
                        </tr>
                                ...
                                <div class="relative flex items-center justify-between">
                                    <div class="flex-1 min-w-0 pr-4">
                                        <div class="flex items-center gap-2">
                                            <span class="text-xs font-bold text-blue-600 uppercase tracking-wider">Booking Detail</span>
                            ...
                            <div v-else-if="detailData" class="flex-1 overflow-hidden flex flex-col bg-slate-50/30">
                                ...
                                <div class="flex-shrink-0 flex border-b border-slate-200 px-6 pt-4 gap-2 bg-white">
                                    <button v-for="tab in [
                                        ...
                                        { key: 'peserta', label: 'Participant',   count: detailData.total_peserta },
                                        { key: 'panitia', label: 'Organizer',   count: detailData.total_panitia },
                                ...
                                <div class="flex-1 overflow-y-auto p-6">
                                    ...
                                    <div v-if="detailTab === 'info'" class="space-y-5">
                                        ...
                                        <div class="bg-slate-50 rounded-xl p-4 border border-slate-100">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Applicant Name</p>
                                                ...
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Division</p>
                                                    <p class="text-sm font-medium text-blue-700">{{ detailData.booking.pemohon?.divisi ?? '-' }}</p>
                                                </div>
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Event PIC</p>
                                                    <p class="text-sm font-medium text-gray-800">{{ detailData.booking.pic ?? '-' }}</p>
                                                </div>
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">PIC Phone Number</p>
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <p class="text-sm font-bold text-gray-800">
                                                        {{ detailData.booking.gabung_ruang ? 'Combined Room (2+3)' : (detailData.booking.ruangan?.nama_ruang ?? '-') }}
                                                    </p>
                                                    <p v-if="detailData.booking.gabung_ruang" class="text-xs text-emerald-600 font-medium mt-0.5">🔗 Combine Mode Active</p>
                                                </div>
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Building Location</p>
                                                    <p class="text-sm text-gray-700">{{ detailData.booking.ruangan?.lokasi_gedung ?? 'Combined Building' }}</p>
                                                </div>
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Room Capacity</p>
                                                    <p class="text-sm font-medium text-gray-700">
                                                        {{ detailData.booking.gabung_ruang ? '60 people (combined)' : (detailData.booking.ruangan?.kapasitas_max ? detailData.booking.ruangan.kapasitas_max + ' people' : '-') }}
                                                    </p>
                                                </div>
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Total People</p>
                                                    <p class="text-sm font-bold text-gray-800">{{ detailData.total_peserta + detailData.total_panitia }} people</p>
                                                </div>
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Start Date</p>
                                                    <p class="text-sm font-semibold text-gray-800">{{ detailData.booking.tgl_mulai }}</p>
                                                </div>
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">End Date</p>
                                        ...
                                        <div class="bg-purple-50 rounded-xl p-4 border border-purple-100">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Layout Preference</p>
                                                ...
                                                <div>
                                                    <p class="text-[11px] text-gray-400 mb-0.5">Booking Phase</p>
                                        ...
                                        <div class="grid grid-cols-3 gap-3">
                                            <div class="bg-blue-50 rounded-xl p-3 text-center border border-blue-100">
                                                ...
                                                <p class="text-xs text-gray-500 mt-0.5">Participant</p>
                                            </div>
                                            <div class="bg-amber-50 rounded-xl p-3 text-center border border-amber-100">
                                                ...
                                                <p class="text-xs text-gray-500 mt-0.5">Organizer</p>
                                            </div>
                                            <div class="bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
                                                ...
                                                <p class="text-xs text-gray-500 mt-0.5">Total People</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div class="bg-pink-50 rounded-xl p-4 border border-pink-100">
                                                <h4 class="text-xs font-bold text-pink-600 uppercase tracking-wider mb-2">Gender Distribution</h4>
                                                <div class="flex items-center gap-3">
                                            ...
                                            <div class="bg-teal-50 rounded-xl p-4 border border-teal-100">
                                                <h4 class="text-xs font-bold text-teal-600 uppercase tracking-wider mb-2">Site Distribution</h4>
                                        ...
                                        <p class="text-xs text-gray-400 text-right flex items-center justify-end gap-1">
                                            ...
                                            Submitted: {{ detailData.booking.created_at }}
                                        </p>
                                    </div>
                                            ...
                                            <table class="min-w-full divide-y divide-gray-100">
                                                <thead class="bg-gray-50">
                                                    <tr>
                                                        ...
                                                        <th class="px-3 py-2.5 text-left text-[10px] font-semibold text-gray-500 uppercase">Full Name</th>
                                                        <th class="px-3 py-2.5 text-center text-[10px] font-semibold text-gray-500 uppercase">NRP</th>
                                                        <th class="px-3 py-2.5 text-left text-[10px] font-semibold text-gray-500 uppercase">Position</th>
                                                        <th class="px-3 py-2.5 text-left text-[10px] font-semibold text-gray-500 uppercase">Site</th>
                                                        <th class="px-3 py-2.5 text-left text-[10px] font-semibold text-gray-500 uppercase">Phone Number</th>
                                                        <th class="px-3 py-2.5 text-center text-[10px] font-semibold text-gray-500 uppercase">Gender</th>
                                                    </tr>
                                                </thead>
                                ...
                                <div class="flex-shrink-0 border-t border-gray-100 px-6 py-4 bg-gray-50">
                                    <p class="text-xs text-gray-500 text-center">Showing booking recap details</p>
                                </div>
